$(document).ready(function () {
    ...
    $('.pre_loader').hide();
    var serialno;
    var BU_table = $('#dept_table').DataTable({
        ...
        buttons: [
            {
                className: 'create_dept',
                id: 'create_dept',
                title: 'Create Department',
                text: "Create Department",
                action: function (e, dt, node, config) {
                    //This will send the page to the location specified
                    window.location.href = APP_URL+'/admin/cms/departments/create';
                }
            },
            {
                extend: 'excelHtml5',
    ...
    $('#dept_table_filter').css('display', 'none');
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    ...
                    $.ajax({
                        url: APP_URL+'/admin/cms/departments/'+id,
                        type: 'DELETE',
                        data: {
                            _token: CSRF_TOKEN,
                            id: id
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    ...
                    let id = $(self).attr('data-id');
                    $.ajax({
                        url: APP_URL+'/admin/cms/departments/restore',
                        type: 'POST',
                        data: {
                            _token: CSRF_TOKEN,
                            id: id
