...
$(document).ready(function () {
    ...
    $('.section_contain').on('click', '.deletelist', function () {
        ...
        // if($("#section_container_" + deleteindex+1)){

        // }
        
            if ($("#deletesection").val() == "") {
                // console.log("saved_data");
                saved_data = {};
            } else {
                saved_data = JSON.parse($("#deletesection").val());
                console.log(saved_data);
            }
            // console.log(saved_data);
            saved_data[deleteindex-1] = deleteindex;
            console.log(saved_data);
    ...
    $('.save_template').on('click', function () {
        ...
        // $('#create_template').trigger('submit');
    });
...
function add_question(type, section) {
    ...
    if($("#section_container_"+section).find('.question_container').children().length==0){
...
function save_question(data) {
    ...
    if ($('#create_template, #edit_template').valid()) {
        ...
        var formElement = document.getElementById('create_template');
