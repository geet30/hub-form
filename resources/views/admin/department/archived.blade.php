...
@section('title') {{ trans('label.archived_dept') }} @endsection
@section('header_css')
<style>
    .buttons-html5 {
        display: none;
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>{{ trans('label.archived_dept') }} </span>
                </li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> {{ trans('label.archived_dept') }} </span>
                        </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="dropdown more-btn">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                <a href="#" class="dropdown-item restore_bu" data-id="{{ $dept->id_encrypted }}"><i
