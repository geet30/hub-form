...
@section('title') {{ trans('label.groups') }} @endsection
@section('content')
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> {{ trans('label.groups') }} </span>
                        </div>
                                    ...
                                    <td>
                                        <div class="dropdown more-btn">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenu_{{$key}}">
                                                <a href="{{ route('groups.edit', $group->id_encrypted) }}"
                                                    class="dropdown-item">
                                                ...
                                                <a href="#" class="dropdown-item archive_group" data-id="{{$group->id_encrypted}}">
