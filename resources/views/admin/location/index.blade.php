...
@section('title') {{ trans('label.locations') }} @endsection
@section('header_css')
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>{{ trans('label.locations') }} </span>
                </li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> {{ trans('label.locations') }} </span>
                        </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="dropdown more-btn">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenu_{{$key}}">
                                                <a href="{{ route('location.edit', $location->id_encrypted) }}"
                                                    class="dropdown-item">
                                                ...
                                                <a href="#" class="dropdown-item archive_location" data-id="{{$location->id_encrypted}}">
