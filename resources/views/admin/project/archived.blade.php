...
@section('title') {{ trans('label.archived_projects') }} @endsection
@section('header_css')
<style>
    .buttons-html5 {
        display: none;
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>{{ trans('label.archived_projects') }} </span>
                </li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> {{ trans('label.archived_projects') }} </span>
                        </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <table id="project_table" class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> {{$i}} </td>
                                    <td>{{$project->vc_name ?? '-'}}</td>
                                    <td>{{$project->business_unit->vc_short_name ?? '-'}}</td>
                                    <td> <div style="display:none;">{{$project->i_status}}</div> @if($project->i_status == 1 )<span class="activated project_status" title="Activated" data-id="activated" ></span> @else <span class="deactivated project_status" title="Deactivated" data-id="deactivated" ></span> @endif</td>
                                    <td>
                                        <div class="dropdown more-btn">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                <a href="#" class="dropdown-item restore_project" data-id="{{ $project->id_encrypted }}"><i
